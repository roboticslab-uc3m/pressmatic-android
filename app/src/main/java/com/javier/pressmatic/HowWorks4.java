...
public class HowWorks4 extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_how_works4);
    ...
    private void actualizaInterfaz() {
        ...
        left.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(HowWorks4.this, HowWorks3.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP| Intent.FLAG_ACTIVITY_SINGLE_TOP));
                finish();
            }});

        right.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(HowWorks4.this, HowWorks5.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP| Intent.FLAG_ACTIVITY_SINGLE_TOP));
                finish();
            }});
        ...
        button_X.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (mApplication.getConnection()) {
                    startActivity(new Intent(HowWorks4.this, Snippers.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP| Intent.FLAG_ACTIVITY_SINGLE_TOP));
                    finish();
                }else {
                    startActivity(new Intent(HowWorks4.this, Pressmatic.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP| Intent.FLAG_ACTIVITY_SINGLE_TOP));
                    finish();
                }
            }});
        ...
        scrollView.setOnTouchListener(new OnSwipeTouchListener(HowWorks4.this) {
            @Override
        ...
        builder.setMessage(R.string.exit_app)
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        unbindService(mConnection);
                        mBluetoothConexion.stop();
                        Intent intent = new Intent(HowWorks4.this, HowWorks4.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP| Intent.FLAG_ACTIVITY_SINGLE_TOP);
                        flag = 1;
                        finish();
